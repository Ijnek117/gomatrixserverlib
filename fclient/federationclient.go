...
// If the encrypted userID follows the spec.UserID the endpoint shouldn't need to be changed.
// TODO: Should we modify to include the encrypted userID as a request field rather than in the path?
